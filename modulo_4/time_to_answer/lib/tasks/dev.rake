namespace :dev do
    ...
    task setup: :environment do
        ...
        show_spinner("Cadastrando perguntas e repostas...") { %x(rails dev:add_answers_and_questions) }
    ...
    task add_answers_and_questions: :environment do
        Subject.all.each do |subject|
            rand(5..10).times do |i|
                ...
                params[:question][:answers_attributes][index]  = { description: Faker::Lorem.setence, correct: true }
